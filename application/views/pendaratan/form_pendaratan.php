				...
				<div class="col-md-10">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form action="<?php echo base_url('home/inputPendaratan'); ?>" method="post" class="form-horizontal">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" name="tanggal" id="datepicker" placeholder="Isikan Tanggal">
									</div>
								</div>
								<div class="hr-dashed"></div>
								<div class="form-group">
