				...
				<div class="col-md-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form action="<?php echo base_url('home/input_setting'); ?>" method="post" class="form-horizontal">
							...
							<?php  } ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control" id="datepicker" name="tanggal" placeholder="Isikan Tanggal Operasi" required="true">
									</div>
								</div>
								<div class="hr-dashed"></div>
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="time" class="form-control" name="jam" placeholder="Isikan Jam Operasi" required="true">
									</div>
								</div>
								<div class="hr-dashed"></div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<a href="<?php echo base_url('operasi_setting/maps') ?>" class="btn btn-primary">Cari Lokasi</a>
									</div>
								</div>
