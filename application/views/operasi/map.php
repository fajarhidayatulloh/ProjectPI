...
<div class="form-group">
 ...
 <script>
      function initMap() {
        ...
        if (navigator.geolocation) {
          navigator.geolocation.getCurrentPosition(function(position) {
            ...
            infoWindow.setContent('<form action="<?php echo base_url('operasi_setting/maps'); ?>" method="post"><table><tr><td><h3>Lokasi Anda.</h3></td></tr>'+
    ...
    <script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBu3hsjoR6w25BS4JdDt-SPah46kxLHtjo&callback=initMap">
    </script>