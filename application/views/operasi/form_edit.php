				...
				<div class="col-md-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form action="<?php echo base_url('operasi_setting/edit'); ?>" method="post" class="form-horizontal">
								<?php foreach($record->result() as $c) :?>
									<input type="hidden" class="form-control" name="id" value="<?php echo $c->id_operasi_setting; ?>">
								...
								<div class="form-group">
									<div class="col-sm-8 col-sm-offset-2">
										...
										<a class='btn btn-default' href="<?php echo base_url('operasi_setting') ?>"> Batal</a>
									</div>
								</div>
								<?php  endforeach ?>
							<form>
