        ...
        if (navigator.geolocation) {
          navigator.geolocation.getCurrentPosition(function(position) {
            ...
            infoWindow.setContent('<table><tr><td><h3>Lokasi Anda.</h3></td></tr>'+
              ...
              '<tr><td><h3>Longitude: </h3></td><td><h3><input type="text" name="lng" value="' + position.coords.longitude + '"></h3>           </td></tr></table><a class="btn btn-primary btn-sm" href="<?php echo base_url()?>"></a>');
            map.setCenter(pos);
          }, function() {
